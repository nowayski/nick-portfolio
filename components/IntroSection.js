...
export default function IntroSection(props) {
  ...
  return (
    <div className="w-100 m-auto grid place-items-center bottom-0">
      <div className="w-100 lg:w-3/4 inset-0 mx-auto lg:my-10 grid grid-rows-2 place-items-center lg:grid-cols-2 lg:grid-rows-1">
        <div className="text-center text-2xl font-bold row-start-2 lg:text-3xl lg:text-left  lg:row-start-1">
          <ul>
            ...
            <li className="p-5">Innovation through constant learning.</li>
